...
- [ ] Day 8: Safety layer (permissions/scopes/limits/velocity) — turns the pipeline preventive, closing the gap the vertical slice deliberately left open
